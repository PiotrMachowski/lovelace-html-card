...
class HtmlCard extends HTMLElement {
    ...
    render() {
        ...
        let overflow = this._config.overflow;
        ...
        this.innerHTML = `<ha-card id="htmlCard" style="padding: 16px ; overflow: ${this._config.overflow}; height: ${this._config.height}; width: ${this._config.width};">${header}<div>${outputContent}</div></ha-card>`;
    }
